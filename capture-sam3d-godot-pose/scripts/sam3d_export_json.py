...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        # created here. A supplied box is more reliable for multi-person,
        # overlapping, or partly occluded poses and keeps this command
        # self-contained.
        ...
        write_json_atomic(args.output, _json_value(outputs))
